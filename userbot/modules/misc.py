...
async def killdabot(event):
    ...
    await event.edit("`Menonaktifkan JESS-UBOT....`")
...
async def killdabot(event):
    await event.edit("`Restarting JESS-UBOT...`")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[JESS-UBOT Repo](https://github.com/Jeskeren/JSS-UBOT/blob/JS-UBOT/README.md)"
