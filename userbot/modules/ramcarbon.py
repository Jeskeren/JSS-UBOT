# Create By : <@merdhni\>
# From KY-UBOT <https://github.com/rizkypratama2/ky-ubot>
# Slebewwwww
...
@register(outgoing=True, pattern=r"^\.(?:rcarbon|carbon)s\")
...
CMD_HELP.update(
    {
        ...
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.rcarbon` <text/reply>\
        \n  ❍▸ : **Carbonisasi teks, dengan warna background acak.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `.ccarbon` <warna> <text/reply>\
