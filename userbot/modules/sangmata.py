...
async def lastname(steal):
    ...
    if message.sender.bot:
        ...
        return
    await steal.edit("LU SIAPA SI KENTOT MAKE AKUN FAKE BISA NYA ANJING,GUA KEPO,KENAPA? GA SENENG PC BABI!!.")
    try:
        async with bot.conversation(chat) as conv:
            ...
            if response.text.startswith("No records") or r.text.startswith(
                ...
                await steal.edit("```Masa Gua Gak Nemu Riwayat Namanya si ngentot, Wah si anjing belom pernah ganti nama kayak nya MEK!!```")
                await steal.client.delete_messages(
