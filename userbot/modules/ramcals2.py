...
@register(outgoing=True, pattern=r"^\.vplay$")
...
@register(outgoing=True, pattern=r"^\.end$")
...
@register(outgoing=True, pattern=r"^\.pause$")
...
@register(outgoing=True, pattern=r"^\.volume(?: |$)(.*)")
...
@register(outgoing=True, pattern=r"^\.playlist$")
